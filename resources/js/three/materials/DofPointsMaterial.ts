    ...
    super({
      ...
      fragmentShader: /* glsl */ `
        ...
        float sparkleNoise(vec3 seed, float time) {
          ...
          // Slightly boosted brightness for more neon feel
          return 0.8 + finalBrightness * 1.6;
        }
        ...
        void main() {
          ...
          // Color blending: base neon pink → hotter magenta on introspect
          vec3 base = uBaseColor;
          vec3 focus = uFocusColor;
          vec3 color = mix(base, focus, uTransition);

          // Apply sparkle as a brightness multiplier
          vec3 finalColor = color * sparkleBrightness;
      ...
      uniforms: {
        ...
        // NEW color uniforms (neon pink palette)
        uBaseColor: { value: new THREE.Color("#ff2ad4") },   // base neon pink
        uFocusColor: { value: new THREE.Color("#ff6bff") },  // brighter magenta when introspecting
      },
      transparent: true,
      depthWrite: false,
